...
//import views.QuestionController;
...
//	
//		        a.setContentText("No Questions in the file OR the schema is incorrect!");
//		        
//		        a.show();
//			}
//		}
...
//		    int corectAnswer = Integer.parseInt((String) questObj.get("correct_ans"));
//		    Question q = new Question(question, answersList.get(3), answersList.get(2), 
//		    		answersList.get(1), answersList.get(0), corectAnswer, QuestionDifficulty.getDifficultybyID(level),team);
//		    //checks validations
...
//				obj.put("correct_ans", q.getRightAnswer()+"");
//				array.add(obj);
//			}
//		}
//		idQ++;
...
//				String date = (String) hObj.get("Game Date");
...
//	}
//	/**
//	* When player finishes the game, it gets the name and score and write to the json file.
//	* we erase the jsons data
//	*/
...
//		try {
//			int qnum = Integer.parseInt(QuestionDifficulty.getIDByDifficulty(q.getDiff()));
//			
