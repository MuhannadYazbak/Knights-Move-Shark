...
public class JsonDataManager {
	...
	public Question questValid(JsonObject questObj)
	{
		try
		{
		    ...
		    Question q = new Question(question, Difficulty.getDifficultybyID(level), answersList.get(3), answersList.get(2), 
		    		answersList.get(1), answersList.get(0), corectAnswer,team);
		    //checks validations
