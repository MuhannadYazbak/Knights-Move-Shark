...
public class GameController {
    ...
    public void MoveTo() {
    		...
    		Image img = new Image(getClass().getResourceAsStream("/lib/king.png"));
    		
    		if(CI00.isPressed()==false)
