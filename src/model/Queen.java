...
public class Queen extends Piece{
	...
	public ArrayList<Square> move(Square state[][],int x,int y)
	{
		...
		while(tempx>=0)
		{
			...
			else if(((Piece) state[tempx][y].getpiece()).getcolor()==this.getcolor())
				break;
			else
			{
				possiblemoves.add(state[tempx][y]);
		...
		while(tempy>=0)
		{
			...
			else if(((Piece) state[x][tempy].getpiece()).getcolor()==this.getcolor())
				break;
			else
			{
				possiblemoves.add(state[x][tempy]);
		...
		while(tempx<8&&tempy>=0)
		{
			...
			else if(((Piece) state[tempx][tempy].getpiece()).getcolor()==this.getcolor())
				break;
			else
			{
				possiblemoves.add(state[tempx][tempy]);
